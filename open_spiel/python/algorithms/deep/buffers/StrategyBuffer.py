...
from open_spiel.python.algorithms.deep.wrappers.IterationWrapper import IterationWrapper


class StrategyBuffer:

    def __init__(self, t_prof, game, device, max_size=None):
        self._t_prof = t_prof
        self._game = game
        self._device = device
    ...
    def load_state_dict(self, state):
        ...
        for net_state_dict, cfr_iter in state["nets"]:
            s = IterationWrapper(t_prof=self._t_prof, game=self._game,
